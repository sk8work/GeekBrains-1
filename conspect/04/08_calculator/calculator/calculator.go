...
func Calculate(expr string) (float64, error) {
	...
	// // exprNode() даст доступ к ветвям дерева, исходящим из корня/ноды     ​//    ​// type Expr interface {    ​//  Node    ​//  exprNode()    ​//
...
// Созание массива функций для обработки данных
func init() {
...
func call(c *ast.CallExpr) (float64, error) {
	...
	default:
		_ = t
		return -1, errors.New("Неизветсный тип функции")
	}
